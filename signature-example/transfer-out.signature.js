...
function generateTransferSignature({ clientKey, timestamp, body, httpMethod, path, privateKey }) {
  ...
  const data = `${httpMethod}:${path}:${timestamp}:${clientKey}:${stringBody}`;
...
const path = '/transaction/transfer-out';
const bodyData = {
  destinationAccountNumber: "5432154321",
  destinationAccountName: "Hendi Sujiadi",
  destinationBankCode: "014",
  amount: 10000,
  merchantId: "A4QZ",
  channelId: "CH-FRP-01",
  partnerReferenceNo: "ts-out-07",
  inquiryId: "ec449431-adf1-445f-afbd-d5c2aa7e0e1f"
};
